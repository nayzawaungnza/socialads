@extends('layouts/master', ['activePage' => 'accounts.create', 'titlePage' => __('New Admin Account')])
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
           ...
           <div class="card mb-4">
                ...
                @else
                  <form  class="card-body" method="POST" action="{{url('/admin/accounts/store')}}" enctype="multipart/form-data" >
                @endisset
                  @csrf
