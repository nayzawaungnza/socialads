@extends('layouts/master', ['activePage' => 'services.create', 'titlePage' => __('New Service')])
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4">
                <span class="text-muted fw-light">service /</span> Create
            </h4>
           ...
           <div class="card mb-4">
                ...
                @else
                  <form  class="card-body" method="POST" action="{{url('/admin/services/store')}}" enctype="multipart/form-data" >
                @endisset
                  @csrf
                  ...
                  <div class="row g-3">
                    <div class="col-md-12">
                      ...
                      <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Service Name" />
                      @error('name')
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                      ...
                      <textarea id="excerpt" value="{{ old('excerpt') }}" name="excerpt" class="editor form-control @error('excerpt') is-invalid @enderror" placeholder="enter excerpt"></textarea>
                      @error('excerpt')
                          <span class="error invalid-feedback" style="margin-left:8px;display:block;">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-md-6">
                      ...
                      <textarea id="extra_focus"  name="extra_focus" class="editor form-control @error('extra_focus') is-invalid @enderror" placeholder="enter focus areas">{{ old('extra_focus') }}</textarea>
                      @error('extra_focus')
                          <span class="error invalid-feedback" style="margin-left:8px;display:block;">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                          ...
                          <textarea id="editor_1" name="sub_title" style="height: 300px; width: 100%;" class="editor form-control" placeholder="Enter sub title">{{ old('sub_title') }}</textarea>
                        </div>
                        <div class="col-md-6">
                          <label class="form-label" for="editor_2">Sub Description</label>
                          <textarea id="editor_2" name="sub_description" style="height: 300px; width: 100%;" class="editor form-control" placeholder="Enter sub Description">{{ old('sub_description') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                          ...
                          <input type="text" id="brand_title" name="brand_title" value="{{ old('brand_title') }}" class="form-control @error('brand_title') is-invalid @enderror" placeholder="Enter brand title" />
                        </div>
                        <div class="col-md-6">
                          <label class="form-label" for="editor_3">Brand Description</label>
                          <textarea id="editor_3" name="brand_description" style="height: 300px; width: 100%;" class="editor form-control" placeholder="Enter brand Description">{{ old('brand_description') }}</textarea>
                        </div>
                    </div>
                    <div class="row g-3">
                        <div class="col-md-6">
                          <label class="form-label" for="business_title">Business Title</label>
                          <input type="text" id="businessn_title" name="business_title" value="{{ old('business_title') }}" class="form-control @error('business_title') is-invalid @enderror" placeholder="Enter business title" />
                        </div>
                    </div>
                    <div class="row g-3">
                        <div class="col-md-6">
                          <label class="form-label" for="personalization_title">Personalization Title</label>
                          <input type="text" id="personalization_title" name="personalization_title" value="{{ old('personalization_title') }}" class="form-control @error('personalization_title') is-invalid @enderror" placeholder="Enter personalization title" />
                        </div>
                        <div class="col-md-6">
                          <label class="form-label" for="editor_4">Personalization Description</label>
                          <textarea id="editor_4" name="personalization_description" style="height: 300px; width: 100%;" class="editor form-control" placeholder="Enter personalization Description">{{ old('personalization_description') }}</textarea>
                        </div>
                    </div>
