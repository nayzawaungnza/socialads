@extends('layouts/master', ['activePage' => 'services', 'titlePage' => __('Services')])
              ...
              <div class="card">
                ...
                Service List
                    <div class="demo-inline-spacing">
                        <a href="{{route('services.create')}}" class="btn btn-secondary add-new btn-primary">
                            <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
                            <span class="d-none d-sm-inline-block">Add New Service</span></a>
                    </div>
                </h5>
                
                <div id="table_url" data-table-url="{{url('admin/services')}}"></div>
                <div class="card-datatable table-responsive text-nowrap">
                  <table class="service-datatables-ajax table">
                    <thead>
                      <tr>
                         <th>Name</th>
                        <th>Slug</th>
