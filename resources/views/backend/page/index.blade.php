@extends('layouts/master', ['activePage' => 'pages', 'titlePage' => __('Pages')])
              ...
              <div class="card">
                ...
                Post List
                    <div class="demo-inline-spacing">
                        <a href="{{route('pages.create')}}" class="btn btn-secondary add-new btn-primary">
                            <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
                            <span class="d-none d-sm-inline-block">Add New Page</span></a>
                    </div>
                </h5>
                
                <div id="table_url" data-table-url="{{url('admin/pages')}}"></div>
                <div class="card-datatable table-responsive text-nowrap">
                  <table class="page-datatables-ajax table">
                    <thead>
                      <tr>
                         <th>Name</th>
                        <th>Slug</th>
