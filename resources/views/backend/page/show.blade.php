@extends('layouts/master', ['activePage' => 'pages.show', 'titlePage' => __('View Page')])
...
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">View /</span> Page Detail
</h4>
<div class="row">
  ...
  <div class="card-body">
    <div class="row">
      ...
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted">{{ $page->name }}</div>
      </div>
      <div class="mb-3 col-md-3 border-bottom pb-3">
        <div class="mb-0 text-wrap fw-semibold">Slug</div>
      </div>
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted">{{ $page->slug }}</div>
      </div>
      ...
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted">{{ $page->excerpt }}</div>
      </div>
      <div class="mb-3 col-md-3 border-bottom pb-3">
        <div class="mb-0 text-wrap fw-semibold">Status</div>
      </div>
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted badge {{ $page->status == 1 ? 'bg-label-success' : 'bg-label-danger' }}">{{ $page->status == 1 ? 'Publish' : 'Draft' }}</div>
      </div>
      <div class="mb-3 col-md-3 border-bottom pb-3">
        <div class="mb-0 text-wrap fw-semibold">Created At</div>
      </div>
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted">{{ $page->created_at }}</div>
      </div>
      <div class="mb-3 col-md-3 border-bottom pb-3">
        <div class="mb-0 text-wrap fw-semibold">Created By</div>
      </div>
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted">{{ $page->createdBy->name }}</div>
      </div>
      <div class="mb-3 col-md-3 border-bottom pb-3">
        <div class="mb-0 text-wrap fw-semibold">Updated At</div>
      </div>
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted">{{ $page->updated_at }}</div>
      </div>
      <div class="mb-3 col-md-3 border-bottom pb-3">
        <div class="mb-0 text-wrap fw-semibold">Updated By</div>
      </div>
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted">{{ $page->updatedBy->name }}</div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-8">
            ...
            <div class="mb-0 text-muted mt-2">{!! $page->description !!}</div>
          
      </div>
      <div class="col-md-4">
          <div class="mb-0 text-wrap fw-semibold border-bottom pb-3">Image</div>
          
          <img src="{{ asset('storage/'.$page->default_image->image_url) }}" alt="" class="mt-2 img-fluid img-thumbnail border-r-2">
      </div>
    </div>
