@extends('layouts/master', ['activePage' => 'pages.edit', 'titlePage' => __('Edit Page')])
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4">
                <span class="text-muted fw-light">Page /</span> Update
            </h4>
           ...
           <div class="card mb-4">
                ...
                @else
                  <form  class="card-body" method="POST" action="{{url('/admin/pages/'.$page->id.'')}}" enctype="multipart/form-data" >
                @endisset
                  @csrf
                  @method('PUT')
                  ...
                  <div class="row g-3">
                    <div class="col-md-12">
                      ...
                      <input type="text" id="name" name="name" value="{{ old('name', $page->name) }}" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Post Name" />
                      @error('name')
                    ...
                    <div>
                      ...
                      <textarea id="editor" name="description" style="height: 300px; width: 100%;" class=" form-control" placeholder="Enter Description">{{ old('description', $page->description) }}</textarea>
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-3">
                            <img id="imagePreview" 
                                src="{{ isset($page) && $page->default_image ? asset('storage/' . $page->default_image->image_url)  : asset('assets/img/backgrounds/5.jpg') }}" 
                                alt="Preview Image" 
                    ...
                    <div class="col-md-6">
                      ...
                      <textarea id="excerpt" value="{{ old('excerpt', $page->excerpt) }}" name="excerpt" class="form-control @error('excerpt') is-invalid @enderror" placeholder="enter excerpt"></textarea>
                      @error('excerpt')
                          <span class="error invalid-feedback" style="margin-left:8px;display:block;">{{ $message }}</span>
                        @enderror
                    </div>
