@extends('layouts/master', ['activePage' => 'subscribers', 'titlePage' => __('Subscribers')])
              ...
              <div class="card">
                ...
                Subscribers List
                    <div class="demo-inline-spacing">
                        <a href="{{route('subscribers.create')}}" class="btn btn-secondary add-new btn-primary">
                        <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
                        <span class="d-none d-sm-inline-block">Add New Subscribers</span></a>
                    </div>
                </h5>
                
                <div id="table_url" data-table-url="{{url('admin/subscribers')}}"></div>
                <div class="card-datatable table-responsive text-nowrap">
                  <table class="subscriber-datatables-ajax table">
                    <thead>
                      <tr>
                         <th>Full name</th>
                        <th>Email</th>
