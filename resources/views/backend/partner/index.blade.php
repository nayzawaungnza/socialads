@extends('layouts/master', ['activePage' => 'partners', 'titlePage' => __('Partners')])
              ...
              <div class="card">
                ...
                Partners List
                    <div class="demo-inline-spacing">
                        <a href="{{route('partners.create')}}" class="btn btn-secondary add-new btn-primary">
                            <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
                            <span class="d-none d-sm-inline-block">Add New Partner</span></a>
                    </div>
                </h5>
                
                <div id="table_url" data-table-url="{{url('admin/partners')}}"></div>
                <div class="card-datatable table-responsive text-nowrap">
                  <table class="partner-datatables-ajax table">
                    <thead>
                      <tr>
                         <th>Name</th>
                        <th>Slug</th>
