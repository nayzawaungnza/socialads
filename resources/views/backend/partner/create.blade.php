@extends('layouts/master', ['activePage' => 'partners.create', 'titlePage' => __('New Partner')])
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4">
                <span class="text-muted fw-light">Partner/</span> Create
            </h4>
           ...
           <div class="card mb-4">
                ...
                @else
                  <form  class="card-body" method="POST" action="{{url('/admin/partners/store')}}" enctype="multipart/form-data" >
                @endisset
                  @csrf
                  ...
                  <div class="row g-3">
                    <div class="col-md-6">
                      ...
                      <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Enter partner Name" />
                      @error('name')
