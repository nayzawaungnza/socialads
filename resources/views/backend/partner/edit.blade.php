@extends('layouts/master', ['activePage' => 'partners.edit', 'titlePage' => __('Edit Partner')])
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4">
                <span class="text-muted fw-light">Partner /</span> Update
            </h4>
           ...
           <div class="card mb-4">
                ...
                @else
                  <form  class="card-body" method="POST" action="{{url('/admin/partners/'.$partner->id.'')}}" enctype="multipart/form-data" >
                @endisset
                  @csrf
                  @method('PUT')
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" id="url" name="url" value="{{ old('url', $partner->url) }}" class="form-control @error('url') is-invalid @enderror" placeholder="Enter website url" />
                      @error('url')
                        <span class="error invalid-feedback" style="margin-left:8px;display:block;">{{ $message }}</span>
                      @enderror
                    </div>
                    <div>
                      ...
                      <textarea id="editor" name="description" style="height: 300px; width: 100%;" class=" form-control" placeholder="Enter Description">{{ old('description', $partner->description) }}</textarea>
                    </div>
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                          <label class="form-label" for="basic-default-upload-file">Partner pic</label>
                        ...
                        <div class="mt-3">
                            <img id="imagePreview" 
                                src="{{ isset($partner) && $partner->default_image ? asset('storage/' . $partner->default_image->image_url)  : asset('assets/img/backgrounds/5.jpg') }}" 
                                alt="Preview Image" 
