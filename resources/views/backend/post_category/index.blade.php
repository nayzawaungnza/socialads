@extends('layouts/master', ['activePage' => 'post_categories', 'titlePage' => __('New Category')])
          ...
          <div class="row">
              <div class="col-md-12">
                  <div class="card mb-4">
                      ...
                      @else
                        <form  class="card-body" method="POST" action="{{url('/admin/post_categories/store')}}" enctype="multipart/form-data">
                      @endisset
                        @csrf
              ...
              <div class="col-md-12">
                  <div class="card mb-4">
                    ...
                    <div id="table_url" data-table-url="{{route('post_categories.index')}}"></div>
