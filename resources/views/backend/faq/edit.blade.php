...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4">
                <span class="text-muted fw-light">FAQ /</span> Update
            </h4>
           ...
           <div class="card mb-4">
                ...
                @else
                  <form  class="card-body" method="POST" action="{{url('/admin/faqs/'.$faq->id.'')}}" enctype="multipart/form-data" >
                @endisset
                  @csrf
                  @method('PUT')
                  ...
                  <div class="row g-3">
                    <div class="col-md-12">
                      ...
                      <input type="text" id="name" name="question" value="{{ old('question', $faq->question) }}" class="form-control @error('question') is-invalid @enderror" placeholder="Enter Question" />
                      @error('question')
                    ...
                    <div>
                      ...
                      <textarea id="editor" name="answer" style="height: 300px; width: 100%;" class=" form-control" placeholder="Enter Answer">{{ old('answer', $faq->answer) }}</textarea>
                    </div>
                    <div class="col-md-6">
                        ...
                        @foreach($services as $service)
                            <div class="form-check mb-2">
                                <input type="radio" 
                                       ...
                                       value="{{ $service->id }}" 
                                       {{ old('service_id', $faq->services->isNotEmpty() ? $faq->services->first()->id : null) == $service->id ? 'checked' : '' }} 
                                       required>
