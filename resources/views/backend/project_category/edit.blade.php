@extends('layouts/master', ['activePage' => 'project_categories', 'titlePage' => __('Edit Category')])
          ...
          <div class="row">
              <div class="col-md-12">
                  <div class="card mb-4">
                      ...
                      @else
                        <form  class="card-body" method="POST" action="{{url('/admin/project_categories/'.$postCategory->id)}}" >
                      @endisset
                        @csrf
                        @method('put')
