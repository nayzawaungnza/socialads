@extends('layouts/master', ['activePage' => 'projects', 'titlePage' => __('Projects')])
              ...
              <div class="card">
                ...
                Project List
                    <div class="demo-inline-spacing">
                        <a href="{{route('projects.create')}}" class="btn btn-secondary add-new btn-primary">
                            <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
                            <span class="d-none d-sm-inline-block">Add New Project</span></a>
                    </div>
                </h5>
                
                <div id="table_url" data-table-url="{{url('admin/projects')}}"></div>
                <div class="card-datatable table-responsive text-nowrap">
                  <table class="project-datatables-ajax table">
                    <thead>
                      <tr>
                         <th>Name</th>
                        <th>Slug</th>
