@extends('layouts/master', ['activePage' => 'sliders.create', 'titlePage' => __('New Slide')])
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
           ...
           <div class="card mb-4">
                ...
                @else
                  <form  class="card-body" method="POST" action="{{url('/admin/sliders/store')}}" enctype="multipart/form-data" >
                @endisset
                  @csrf
                  ...
                  <div class="row g-3">
                    <div class="col-md-6">
                      ...
                      <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Slider Name" />
                      @error('name')
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" id="subname" name="subname" value="{{ old('subname') }}" class="form-control @error('subname') is-invalid @enderror" placeholder="Enter Slider Sub Name" />
                      @error('subname')
                        <span class="error invalid-feedback" style="margin-left:8px;display:block;">{{ $message }}</span>
                      @enderror
                    </div>
                    <div class="col-md-6">
                      ...
                      <input type="text" id="button_text" name="button_text" value="{{ old('button_text') }}" class="form-control @error('button_text') is-invalid @enderror" placeholder="Enter Button Label" />
                      @error('button_text')
                        <span class="error invalid-feedback" style="margin-left:8px;display:block;">{{ $message }}</span>
                      @enderror
                    </div>
                    <div class="col-md-6">
                      ...
                      <input type="text" id="button_url" name="button_url" value="{{ old('button_url') }}" class="form-control @error('button_url') is-invalid @enderror" placeholder="Enter button url" />
                      @error('button_url')
                        <span class="error invalid-feedback" style="margin-left:8px;display:block;">{{ $message }}</span>
                      @enderror
                    </div>
