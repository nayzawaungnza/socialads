@extends('layouts/master', ['activePage' => 'clients', 'titlePage' => __('Clients')])
              ...
              <div class="card">
                ...
                Clients List
                    <div class="demo-inline-spacing">
                        <a href="{{route('clients.create')}}" class="btn btn-secondary add-new btn-primary">
                            <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
                            <span class="d-none d-sm-inline-block">Add New Client</span></a>
                    </div>
                </h5>
                
                <div id="table_url" data-table-url="{{url('admin/clients')}}"></div>
                <div class="card-datatable table-responsive text-nowrap">
                  <table class="client-datatables-ajax table">
                    <thead>
                      <tr>
                         <th>Name</th>
                        <th>Slug</th>
