@extends('layouts/master', ['activePage' => 'clients.show', 'titlePage' => __('View Client')])
...
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">View /</span> Client Detail
</h4>
<div class="row">
  ...
  <div class="card-body">
    <div class="row">
      ...
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted">{{ $client->name }}</div>
      </div>
      <div class="mb-3 col-md-3 border-bottom pb-3">
        <div class="mb-0 text-wrap fw-semibold">Slug</div>
      </div>
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted">{{ $client->slug }}</div>
      </div>
      ...
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted"><a class="btn btn-primary" href="{{ $client->url ?? '#' }}" target="_blank" rel="noopener noreferrer">Click Here</a></div>
      </div>
      <div class="mb-3 col-md-3 border-bottom pb-3">
        <div class="mb-0 text-wrap fw-semibold">Status</div>
      </div>
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted badge {{ $client->status == 1 ? 'bg-label-success' : 'bg-label-danger' }}">{{ $client->status == 1 ? 'Publish' : 'Draft' }}</div>
      </div>
      <div class="mb-3 col-md-3 border-bottom pb-3">
        <div class="mb-0 text-wrap fw-semibold">Created At</div>
      </div>
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted">{{ $client->created_at }}</div>
      </div>
      <div class="mb-3 col-md-3 border-bottom pb-3">
        <div class="mb-0 text-wrap fw-semibold">Created By</div>
      </div>
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted">{{ $client->createdBy->name }}</div>
      </div>
      <div class="mb-3 col-md-3 border-bottom pb-3">
        <div class="mb-0 text-wrap fw-semibold">Updated At</div>
      </div>
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted">{{ $client->updated_at }}</div>
      </div>
      <div class="mb-3 col-md-3 border-bottom pb-3">
        <div class="mb-0 text-wrap fw-semibold">Updated By</div>
      </div>
      <div class="mb-3 col-md-9 border-bottom pb-3">
        <div class="mb-0 text-muted">{{ $client->updatedBy->name }}</div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-8">
            ...
            <div class="mb-0 text-muted mt-2">{!! $client->description !!}</div>
          
      </div>
      <div class="col-md-4">
          <div class="mb-0 text-wrap fw-semibold border-bottom pb-3">Image</div>
          
          <img src="{{ asset('storage/'.$client->default_image->image_url) }}" alt="" class="mt-2 img-fluid img-thumbnail border-r-2">
      </div>
    </div>
