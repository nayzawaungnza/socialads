@extends('layouts/master', ['activePage' => 'clients.edit', 'titlePage' => __('Edit Client')])
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4">
                <span class="text-muted fw-light">Client /</span> Update
            </h4>
           ...
           <div class="card mb-4">
                ...
                @else
                  <form  class="card-body" method="POST" action="{{url('/admin/clients/'.$client->id.'')}}" enctype="multipart/form-data" >
                @endisset
                  @csrf
                  @method('PUT')
                  ...
                  <div class="row g-3">
                    <div class="col-md-6">
                      ...
                      <input type="text" id="name" name="name" value="{{ old('name', $client->name) }}" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Client Name" />
                      @error('name')
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" id="url" name="url" value="{{ old('url', $client->url) }}" class="form-control @error('url') is-invalid @enderror" placeholder="Enter website url" />
                      @error('url')
                        <span class="error invalid-feedback" style="margin-left:8px;display:block;">{{ $message }}</span>
                      @enderror
                    </div>
                    <div>
                      ...
                      <textarea id="editor" name="description" style="height: 300px; width: 100%;" class=" form-control" placeholder="Enter Description">{{ old('description', $client->description) }}</textarea>
                    </div>
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-3">
                            <img id="imagePreview" 
                                src="{{ isset($client) && $client->default_image ? asset('storage/' . $client->default_image->image_url)  : asset('assets/img/backgrounds/5.jpg') }}" 
                                alt="Preview Image" 
