        ...
        <div class="row">
            <div class="col-md-12">
                <div class="social-ads-flex mb-5">
                    <h3 style="color: #e600ff;" class="social-labs-normal-title text-align-left aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">CLIENT SUCCESS STORIES</h3>
