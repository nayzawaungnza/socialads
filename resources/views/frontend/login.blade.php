            ...
            <div class="row gy-4 align-items-center">
                <div class="col-lg-6">
                    <div class="bg-main-25 border border-neutral-30 rounded-8 p-32">
                        ...
                        <form action="{{ $url ?? route('frontend.postlogin')}}" method="POST">
                            @csrf
                            <div class="mb-24">
                                <label for="email" class="fw-medium text-lg text-neutral-500 mb-16 ">Enter Your Email ID</label>
                                <input type="email" value="{{old('email')}}" class="common-input rounded-pill @error('email') is-invalid @enderror" name="email" id="email" placeholder="Enter Your Email...">
                                @error('email')
