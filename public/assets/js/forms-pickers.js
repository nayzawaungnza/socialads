...
(function () {
  ...
  const flatpickrDate = document.querySelector('#flatpickr-date'),
    ...
    flatpickrDateTimeStartDate = document.querySelector('#flatpickr-datetime-start-date'),
    flatpickrDateTimeEndDate = document.querySelector('#flatpickr-datetime-end-date'),
    flatpickrDateTimeEnd = document.querySelector('#flatpickr-datetime-end'),
    flatpickrDateTimeStart = document.querySelector('#flatpickr-datetime-start'),
  ...
  if (flatpickrDateTimeStartDate) {
    flatpickrDateTimeStartDate.flatpickr({
      enableTime: true,
      dateFormat: 'd-m-Y h:i K'
    });
  }
  if (flatpickrDateTimeEndDate) {
    flatpickrDateTimeEndDate.flatpickr({
      enableTime: true,
      dateFormat: 'd-m-Y h:i K'
    });
  }
  if (flatpickrDateTimeStart) {
