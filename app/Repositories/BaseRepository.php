...
abstract class BaseRepository implements RepositoryContract
{
    ...
    public function deleteById($id): bool
    {
        ...
        if ($model) {
            ...
            return $model->delete(); // This will handle soft deletes if applicable
        }
    
        // If the model was not found, return false or throw an exception
        return false; 
    ...
    public function scopeLike($field, $value)
    {
        return $this->model->where($field, 'ILIKE', "%$value%")->get();
    }
